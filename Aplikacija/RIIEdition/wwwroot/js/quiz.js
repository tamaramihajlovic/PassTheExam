...
{
    mapa.set(pitanja[i], [odgovori[i*5], odgovori[i*5+1], odgovori[i*5+2], odgovori[i*5+3], odgovori[i*5+4]]);
}
...
{
    var currentIndex = nizOdgovora.length - 1, temporaryValue, randomIndex;
...
function prikaziRezultat()
{
   ...
   document.getElementById("krajBtn").style.display="block";
    ...
    if (poeni >= 2)
    {
        kontejnerce.style.background = "url(https://cdn.dribbble.com/users/1476693/screenshots/7986326/media/0ccb1c2ddad5ef34f7df874a20be74e2.gif) repeat center center";
        kontejnerce.style.backgroundSize = "100%";
    }
    else
    {
        kontejnerce.style.background = "url(https://miro.medium.com/max/1700/0*z-SXY5g-6usnMgKp.gif) repeat center center";
